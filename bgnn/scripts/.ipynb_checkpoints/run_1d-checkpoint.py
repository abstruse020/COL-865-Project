...
# from bgnn.models.FRMCC import Frc_mlp
    ...
    def define_model(self, model_name, ps):
        if model_name == 'catboost':
            ...
            if use_predection == '2d clf':
                ...
                Frc_mlp.fit(frc_clf_pred[self.train_mask], y_train)
                new_data = Frc_mlp.predict(frc_clf_pred, self.y)
